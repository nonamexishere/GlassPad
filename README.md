...
- **Always on top, everywhere** — floats above all windows, follows you across Spaces, stays put when you switch apps. Drag anywhere on its background to move it.
- **One persistent note** — a single scratchpad that autosaves on every keystroke and survives restarts. No files, no documents, no save button.
